...
$.extend($.validator, {
	...
	methods: {
		...
		equalTo: function(value, element, param) {
			...
			// CosmosDb.QuickStart find a way to bind the event just once, avoiding the unbind-rebind overhead
...
;(function($) {
	...
	// CosmosDb.QuickStart verify if jQuery 1.4's implementation is compatible with older jQuery special-event APIs
